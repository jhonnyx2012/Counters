...
public abstract class BaseFragment<BINDER extends ViewDataBinding> extends Fragment {
    ...
    protected boolean isBaseStackFragment() {return false;}
    ...
    public boolean orientationHasChange(){return orientationHasChange;}
    ...
    public int getMenuId() {return R.menu.empty_menu;}
